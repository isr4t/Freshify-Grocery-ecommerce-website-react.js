...
const Process = () => {
  ...
  <div className={`flex-1 basis-[300px] ${item.id % 2 === 0 ? 'md:-mt-100' : ''} `}>
        ...
        <span className="flex justify-center items-center w-18 h-18 mx-auto rounded-full text-8xl bg-zinc-800 text-white outline-[4px] outline-offset-7 outline-zinc-800 outline-dotted ">{item.number}</span>
...
const steps = [
  {
    ...
    title: "Sourcing",
    para: "It is a log established fact that a reader",
    icon: <PiPlant />,
  },
  {
    id: 2,
